...
public class TinderBoltApp extends MultiSessionTelegramBot {
    public static final String TELEGRAM_BOT_NAME = "Tinder_ai_dushilovich_bot"; //TODO: добавь имя бота в кавычках
    public static final String TELEGRAM_BOT_TOKEN = "7418957978:AAEdfUv6C_1XeHAYWMYbRgVy02BX3TlCI6s"; //TODO: добавь токен бота в кавычках
    ...
    public void onUpdateEventReceived(Update update) {
        ...
        if (currentMode == DialogMode.GPT && !isMessageCommand()) {
            ...
            updateTextMessage(msg,answer);            return;
        }
        ...
        if (currentMode == DialogMode.DATE && !isMessageCommand()) {
            ...
            if (query.startsWith("date_")) {
                ...
                sendTextMessage("Отличный выбор!\nТвоя задача пригласить партнёра на свидание ❤\uFE0F за 5 сообщений.");
            ...
            Message msg = sendTextMessage("Подождите, партнёр набирает текст...");
        ...
        if(currentMode == DialogMode.PROFILE && !isMessageCommand()) {
            switch (questionCount) {
                ...
                case 3:
                    me.hobby = message;
                    questionCount = 4;
                    sendTextMessage("Что вам НЕ нравится в людям?");
                    return;
                case 4:
                    me.annoys = message;
                    questionCount = 5;
        ...
        sendTextMessage("Чем я могу вам помочь?");
